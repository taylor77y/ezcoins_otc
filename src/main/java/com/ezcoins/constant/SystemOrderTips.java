...
public interface SystemOrderTips {
    ...
    String RELEASE_SELL="您已经确定收到到付，货币已转出到买家";
    String RELEASE_BUY="对方已确认收到您的付款，您所购买的货币已发放到您的账户,请查收";
    ...
    String APPEALING_ID = "您的申诉已提交，请等待处理结果";
    String APPEALING_TO_ID = "对方已提前申诉，请进行处理";


    String APPEAL_OFF= "申诉已取消，请联系对方处理";
